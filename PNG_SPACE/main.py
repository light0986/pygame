...
#player 
PLAYER_SHIP_IMG = pygame.image.load(os.path.join("PNG_SPACE",'player.png'))
PLAYER_SHIP = pygame.transform.scale(PLAYER_SHIP_IMG,(50,50))#player大小

#enemy
ENEMY_SHIP1_IMG = pygame.image.load(os.path.join("PNG_SPACE","enemy.png"))
ENEMY_SHIP2_IMG = pygame.image.load(os.path.join("PNG_SPACE","enemy.png"))
ENEMY_SHIP3_IMG = pygame.image.load(os.path.join("PNG_SPACE","enemy.png"))
ENEMY_SHIP4_IMG = pygame.image.load(os.path.join("PNG_SPACE","enemy.png"))
ENEMY_SHIP5_IMG = pygame.image.load(os.path.join("PNG_SPACE","enemy.png"))
...
#laser
PLATER_LASER_IMG = pygame.image.load(os.path.join("PNG_SPACE","dot_PNG29.png"))
ENEMY_SHIP1_LASER_IMG = pygame.image.load(os.path.join("PNG_SPACE","dot_PNG29.png"))
ENEMY_SHIP2_LASER_IMG = pygame.image.load(os.path.join("PNG_SPACE","dot_PNG29.png"))
ENEMY_SHIP3_LASER_IMG = pygame.image.load(os.path.join("PNG_SPACE","dot_PNG29.png"))
ENEMY_SHIP4_LASER_IMG = pygame.image.load(os.path.join("PNG_SPACE","dot_PNG29.png"))
ENEMY_SHIP5_LASER_IMG = pygame.image.load(os.path.join("PNG_SPACE","dot_PNG29.png"))
...
class Ship:
    ...
    def move_lasers(self, vel, obj):
        ...
        for laser in self.lasers:
            ...
            if laser.off_screen(HEIGHT):
                ...
                obj.health -=10
                pygame.mixer.music.load('./PNG_SPACE/qfrmy-dckrk.ogg') 
    ...
    def shoot(self):
        if self.cool_down_counter == 0:
            ...
            pygame.mixer.music.load('./PNG_SPACE/k1lyj-jsvto.ogg')
            pygame.mixer.music.play()
...
def main():
    ...
    with open("./PNG_SPACE/savegame.txt", "rb") as f:#讀取紀錄
        foo = int(f.read())
    ...
    while run:
        ...
        if lose2 and lose :
            pygame.mixer.music.load('./PNG_SPACE/4suvh-piwjo.ogg')
            pygame.mixer.music.play()
            lose2 = False
        ...
        if lose:
            if lose_count <= 300:
                ...
                if player.score >= foo:
                    ps = str(player.score)
                    sv = open("./PNG_SPACE/savegame.txt","w")#存檔
                    sv.write(ps)
                    sv.close()
        ...
        if len(enemies) == 0:
            level += 1
            pygame.mixer.music.load('./PNG_SPACE/xhhkb-o06br.ogg')
            pygame.mixer.music.play()
            wave_length += 5
